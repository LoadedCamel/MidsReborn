...
namespace Hero_Designer
{
    public class clsOutput
    {
        ...
        public string Build(string iDataLink)
        {
            ...
            string str3 = str1 + formatColor(formatBold(str2 + " Plan by Mids' Reborn : Hero Designer " + MidsContext.AppAssemblyVersion), ExportConfig.Element.Heading) + LineBreak() + formatColor(formatBold(@"https://github.com/Reborn-Team/Hero-Designer"), ExportConfig.Element.Heading) + LineBreak();
            if (iDataLink != "" && !Plain)
