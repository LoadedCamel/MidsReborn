    ...
    public partial class frmTotalsV2 : Form
    {
        ...
        */
        ...
        public void UpdateData()
        {
            ...
            #region Bars setup
            //FetchBar(Enums.eBarType.DefenseSmashing).SuspendUpdate();
            FetchBar(Enums.eBarType.DefenseSmashing).ValueMainBar = displayStats.Defense(0);
            //FetchBar(Enums.eBarType.DefenseSmashing).ResumeUpdate();
            //FetchBar(Enums.eBarType.DefenseLethal).SuspendUpdate();
            FetchBar(Enums.eBarType.DefenseLethal).ValueMainBar = displayStats.Defense(1);
            //FetchBar(Enums.eBarType.DefenseLethal).ResumeUpdate();
            //FetchBar(Enums.eBarType.DefenseFire).SuspendUpdate();
            FetchBar(Enums.eBarType.DefenseFire).ValueMainBar = displayStats.Defense(2);
            //FetchBar(Enums.eBarType.DefenseFire).ResumeUpdate();
            //FetchBar(Enums.eBarType.DefenseCold).SuspendUpdate();
            FetchBar(Enums.eBarType.DefenseCold).ValueMainBar = displayStats.Defense(3);
            //FetchBar(Enums.eBarType.DefenseCold).ResumeUpdate();
            //FetchBar(Enums.eBarType.DefenseEnergy).SuspendUpdate();
            FetchBar(Enums.eBarType.DefenseEnergy).ValueMainBar = displayStats.Defense(4);
            //FetchBar(Enums.eBarType.DefenseEnergy).ResumeUpdate();
            //FetchBar(Enums.eBarType.DefenseNegative).SuspendUpdate();
            FetchBar(Enums.eBarType.DefenseNegative).ValueMainBar = displayStats.Defense(5);
            //FetchBar(Enums.eBarType.DefenseNegative).ResumeUpdate();
            //FetchBar(Enums.eBarType.DefensePsionic).SuspendUpdate();
            FetchBar(Enums.eBarType.DefensePsionic).ValueMainBar = displayStats.Defense(6);
            //FetchBar(Enums.eBarType.DefensePsionic).ResumeUpdate();
            //FetchBar(Enums.eBarType.DefenseMelee).SuspendUpdate();
            FetchBar(Enums.eBarType.DefenseMelee).ValueMainBar = displayStats.Defense(7);
            //FetchBar(Enums.eBarType.DefenseMelee).ResumeUpdate();
            //FetchBar(Enums.eBarType.DefenseRanged).SuspendUpdate();
            FetchBar(Enums.eBarType.DefenseRanged).ValueMainBar = displayStats.Defense(8);
            //FetchBar(Enums.eBarType.DefenseRanged).ResumeUpdate();
            //FetchBar(Enums.eBarType.DefenseAoE).SuspendUpdate();
            FetchBar(Enums.eBarType.DefenseAoE).ValueMainBar = displayStats.Defense(9);
            //FetchBar(Enums.eBarType.DefenseAoE).ResumeUpdate();
            ...
            #region Labels setup
            FetchLv(Enums.eBarType.DefenseSmashing).Text = FormatValue(0, displayStats.Defense(0));
            FetchLv(Enums.eBarType.DefenseLethal).Text = FormatValue(0, displayStats.Defense(1));
            FetchLv(Enums.eBarType.DefenseFire).Text = FormatValue(0, displayStats.Defense(2));
            FetchLv(Enums.eBarType.DefenseCold).Text = FormatValue(0, displayStats.Defense(3));
            FetchLv(Enums.eBarType.DefenseEnergy).Text = FormatValue(0, displayStats.Defense(4));
            FetchLv(Enums.eBarType.DefenseNegative).Text = FormatValue(0, displayStats.Defense(5));
            FetchLv(Enums.eBarType.DefensePsionic).Text = FormatValue(0, displayStats.Defense(6));
            FetchLv(Enums.eBarType.DefenseMelee).Text = FormatValue(0, displayStats.Defense(7));
            FetchLv(Enums.eBarType.DefenseRanged).Text = FormatValue(0, displayStats.Defense(8));
            FetchLv(Enums.eBarType.DefenseAoE).Text = FormatValue(0, displayStats.Defense(9));

            FetchLv(Enums.eBarType.ResistanceSmashing).Text = FormatValue(0, displayStats.DamageResistance(0, false));
            FetchLv(Enums.eBarType.ResistanceLethal).Text = FormatValue(0, displayStats.DamageResistance(1, false));
            FetchLv(Enums.eBarType.ResistanceFire).Text = FormatValue(0, displayStats.DamageResistance(2, false));
            FetchLv(Enums.eBarType.ResistanceCold).Text = FormatValue(0, displayStats.DamageResistance(3, false));
            FetchLv(Enums.eBarType.ResistanceEnergy).Text = FormatValue(0, displayStats.DamageResistance(4, false));
            FetchLv(Enums.eBarType.ResistanceNegative).Text = FormatValue(0, displayStats.DamageResistance(5, false));
            FetchLv(Enums.eBarType.ResistanceToxic).Text = FormatValue(0, displayStats.DamageResistance(6, false));
            FetchLv(Enums.eBarType.ResistancePsionic).Text = FormatValue(0, displayStats.DamageResistance(7, false));
