...
namespace Hero_Designer
{
    public partial class frmColorSettings : Form
    {
        ...
        {
            Load += frmColorSettings_Load;
            InitializeComponent();
            Listlabel1.ItemClick += Listlabel1_ItemClick;
            Name = nameof(frmColorSettings);
            var componentResourceManager = new ComponentResourceManager(typeof(frmColorSettings));
        ...
        void frmColorSettings_Load(object sender, EventArgs e)
