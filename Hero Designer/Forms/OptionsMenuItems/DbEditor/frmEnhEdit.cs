...
namespace Hero_Designer.Forms
{
    public partial class frmEnhData : Form
    {
        ...
        private void cbRecipe_SelectedIndexChanged(object sender, EventArgs e) // test
        ...
        private void DisplayAll()
        {
            ...
            var matchedItem = Regex.Replace(txtInternal.Text, "(Crafted_|Attuned_|Superior_Attuned_)", "");
            switch (myEnh.TypeID)
            {
                case Enums.eType.Normal:
                    ...
                    var selectedIndice = cbRecipe.Items.IndexOf("None");
                    if (selectedIndice != -1)
                    {
                        cbRecipe.SelectedIndex = selectedIndice;
                    }
                ...
                case Enums.eType.InventO:
                    ...
                    cbSubType.SelectedIndex = -1;
                    cbSubType.Enabled = false;
                    var matchedChar = new Regex("[^_]+$");
                    matchedItem = Regex.Replace(matchedItem, "[^_]+$", matchedChar.Match(matchedItem).Value.ToUpper());
                    selectedIndice = cbRecipe.Items.IndexOf(matchedItem);
                    if (selectedIndice != -1)
                    {
                        cbRecipe.SelectedIndex = selectedIndice;
                    }
                    ...
                    {
                        selectedIndice = cbRecipe.Items.IndexOf("Alt");
                        cbRecipe.SelectedIndex = selectedIndice;
                    }
                ...
                case Enums.eType.SpecialO:
                    ...
                    cbRecipe.Enabled = false;
                    selectedIndice = cbRecipe.Items.IndexOf("None");
                    if (selectedIndice != -1)
                    {
                        cbRecipe.SelectedIndex = selectedIndice;
                    }
