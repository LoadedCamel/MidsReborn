...
namespace midsControls
{
    public partial class ListLabelV3 : UserControl
    {
        ...
        void ListLabelV3_MouseDown(object sender, MouseEventArgs e)
        {
            checked
            {
                        ...
                        case eMouseTarget.Item:
                            {
                                ...
                                if (itemAtY > -1)
                                {
                                    ...
                                    if ((num2 + Items[itemAtY].ItemHeight >= e.Y & num2 + Items[itemAtY].ItemHeight <= TextArea.Height) |
                                        (Items[itemAtY].LineCount > 1 & num2 + ActualLineHeight >= e.Y & num2 + ActualLineHeight <= TextArea.Height))
                                    {
        ...
        void ListLabelV3_MouseLeave(object sender, EventArgs e)
        {
        ...
        void ListLabelV3_MouseMove(object sender, MouseEventArgs e)
        {
                        ...
                        case eMouseTarget.Item:
                            {
                                ...
                                if (!((num + Items[itemAtY].ItemHeight >= e.Y & num + Items[itemAtY].ItemHeight <= TextArea.Height) |
                                      (Items[itemAtY].LineCount > 1 & num + ActualLineHeight >= e.Y & num + ActualLineHeight <= TextArea.Height)))
                                {
                                    if (HoverID != -1)
                                    {
                                        flag = true;
        ...
        void ListLabelV3_MouseUp(object sender, MouseEventArgs e)
        {
            DragMode = false;
        ...
        void ListLabelV3_Paint(object sender, PaintEventArgs e)
        {
            if (bxBuffer == null)
            {
                Draw();
        ...
        void ListLabelV3_Resize(object sender, EventArgs e)
        {
            ScrollOffset = 0;
            Recalculate();
            Draw();
        ...
        void ListLabelV3_FontChanged(object sender, EventArgs e)
        {
            Recalculate();
            Draw();
        }

        void ListLabelV3_Load(object sender, EventArgs e)
        {
            szNormal = Size;
            DisableRedraw = true;
            InitBuffer();
        ...
        private void DrawItem(int Index)
        {
            checked
            {
                ...
                {
                    if (num + ActualLineHeight > TextArea.Height)
                    {
                        return;
                    }
        ...
        public class ListLabelItemV3
        {
            ...
            public ListLabelItemV3(string iText, LLItemState iState, int inIDSet = -1, int iIDXPower = -1, int inIDPower = -1,
