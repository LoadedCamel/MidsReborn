...
namespace Mids_Reborn.UIv2.Controls
{
    public sealed partial class PowerList : UserControl
    {
        ...
        public PowerList()
        {
            ...
            _listPanel.HoverStateChanged += ListPanelOnHoverItemChanged;
        ...
        {
            if (e.Index >= 0) DropDownItemHovered?.Invoke(this, _typeDropDown.Items[e.Index] as IPowerset);
        }
        ...
        private void ListPanelOnMouseMove(object? sender, MouseEventArgs e)
        {
            ...
            {
                //HoverItem = _listPanel.Items[_listPanel.HoverIndex] as ListPanelItem;
                HoverItem = Items[_listPanel.HoverIndex];
                Debug.WriteLine($"Hover Index: {Items[_listPanel.HoverIndex]} \n\tHoverItem: {Items[_listPanel.HoverIndex].Text}");    
                ItemHovered?.Invoke(this, HoverItem, e);
            }
            else
            {
        ...
        private void ListPanelOnHoverItemChanged(object? sender, PowerListItemEventArgs e)
        {
            HoverItem = e.Item;
        }
        ...
        private void TypeDropDownOnSelectedIndexChanged(object? sender, EventArgs e)
        {
            ...
            var selectedSet = _typeDropDown.Items[_typeDropDown.SelectedIndex] as Powerset;
        ...
        public class PowerListItemEventArgs : EventArgs
        {
            public ListPanelItem? Item { get; set; }
            public PowerListItemEventArgs(ListPanelItem? item)
            {
                Item = item;
            }
        }
                ...
                if (e.Index >= 0 && e.Index < Items.Count)
                {
                    ...
                    switch (DropType)
                    {
                        case DropDownType.Primary:
                            ...
                            selected = Items[e.Index] as IPowerset;
                            selectedImage = images.FirstOrDefault(i => selected != null && i != null && i.Contains(selected.ImageName));
        ...
        public sealed class ListPanel : ListBox
        {
            ...
            public event EventHandler<PowerListItemEventArgs>? HoverStateChanged;
            ...
            protected override void OnMouseMove(MouseEventArgs e)
            {
                ...
                var newHoverIndex = (index >= 0 && index < Items.Count && ((ListPanelItem)Items[index]).Bounds.Contains(point))
                    ? index
                    : -1;
                ...
                if (newHoverIndex != _hoverIndex)
                {
                    ...
                    var item = newHoverIndex >= 0 ? (ListPanelItem)Items[newHoverIndex] : null;
                    HoverStateChanged?.Invoke(this, new PowerListItemEventArgs(item));
                    Invalidate();
                }
            }
