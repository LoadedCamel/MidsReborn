...
namespace Mids_Reborn.Forms.ImportExportItems
{
    public partial class ThemeCreator : Form
    {
        ...
        private void Button1_Click(object sender, EventArgs e)
        {
            ...
            {
                using var errorBox = new MessageBoxEx("Validation Error", "Please correct validation errors or cancel by clicking the x in the top right hand corner.", MessageBoxEx.MessageBoxExButtons.Okay, MessageBoxEx.MessageBoxExIcon.Error, true);
