        ...
        private void values_DPE()
        {
            ...
            do
            {
                for (var subPowIdx = 0; subPowIdx <= Powers[powIdx].Length - 1; ++subPowIdx)
                {
                    ...
                    Tips[powIdx][subPowIdx] = $"{Tips[powIdx][subPowIdx]} - DPE: {Convert.ToDecimal(Values[powIdx][subPowIdx]):###.##}";
        ...
        private void values_End()
        {
            ...
            do
            {
                ...
                for (var index2 = 0; index2 <= num2; ++index2)
                {
                    ...
                    var index5 = index1;
                    var index6 = index2;
                    tips1[index5][index6] = $"{tips1[index5][index6]}\r\n End: {Convert.ToDecimal(Powers[index1][index2].EndCost):###.##}";
        ...
        private void values_EPS()
        {
            ...
            do
            {
                ...
                for (var index2 = 0; index2 <= num2; ++index2)
                {
                    ...
                    var index5 = index1;
                    var index6 = index2;
                    tips1[index5][index6] = $"{tips1[index5][index6]}\r\n  End: {Convert.ToDecimal(Values[index1][index2]):###.##}";
                    var tips2 = Tips;
                    var index7 = index1;
                    var index8 = index2;
        ...
        private void values_HPE()
        {
            ...
            do
            {
                ...
                for (var index2 = 0; index2 <= num2; ++index2)
                {
                    ...
                    var index5 = index1;
                    var index6 = index2;
                    tips1[index5][index6] = $"{tips1[index5][index6]}\r\n Heal: {Convert.ToDecimal(Values[index1][index2]):###.##} HP per unit of end.";
                    if (num1 < (double) Values[index1][index2])
                        num1 = Values[index1][index2];
                }
        ...
        private void values_HPS()
        {
            ...
            do
            {
                ...
                for (var index2 = 0; index2 <= num2; ++index2)
                {
                    ...
                    var index5 = index1;
                    var index6 = index2;
                    tips1[index5][index6] = $"{tips1[index5][index6]}\r\n Heal: {Convert.ToDecimal(Values[index1][index2]):###.##} HP/s";
                    if (num1 < (double) Values[index1][index2])
                        num1 = Values[index1][index2];
                }
        ...
        private void values_Recharge()
        {
            ...
            do
            {
                ...
                for (var index2 = 0; index2 <= num2; ++index2)
                {
                    ...
                    var index5 = index1;
                    var index6 = index2;
                    tips1[index5][index6] = $"{tips1[index5][index6]}\r\n {Convert.ToDecimal(Values[index1][index2]):###.##}s";
                    if (num1 < (double) Values[index1][index2])
                        num1 = Values[index1][index2];
                }
