...
{
    /// <summary>
    /// Ported from portions of the HexConverter from .NET 7. Certain methods were updated for modern practices using the latest version available in .NET 6 by Crytilis
    /// </summary>
    internal static class MrbHexConverter
    {
        ...
        {
            if (IntPtr.Size != 8) return FromChar(c) != 0xFF;
