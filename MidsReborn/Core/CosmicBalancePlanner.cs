...
internal sealed class CosmicBalanceComputedState
{
    public float DamageMagnitude { get; init; }
    public float ResistanceMagnitude { get; init; }
    public float MezProtectionMagnitude { get; init; }
    public float MezResistanceMagnitude { get; init; }
    public float RechargeSlowResistanceMagnitude { get; init; }
}

internal static class CosmicBalancePlanner
{
    internal const string CosmicBalancePowerFullName = "Inherent.Inherent.Cosmic_Balance";
    ...
    public static bool IsManagedComputedPower(IPower? power)
    {
        return power != null &&
               ...
               power.FullName.Equals(CosmicBalancePowerFullName, StringComparison.OrdinalIgnoreCase);
    }
