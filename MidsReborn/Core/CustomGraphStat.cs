        ...
        public static class Names
        {
            public static string CustomStatNameShort(eCustomGraphStat stat)
            {
                return stat switch
                {
                    ...
                    eCustomGraphStat.Defense => "Enh(Def)",
                    eCustomGraphStat.Resistance => "Enh(Res)",
                    eCustomGraphStat.Regeneration => "Enh(Rgn)",
            ...
            public static string CustomStatNameLong(eCustomGraphStat stat)
            {
                return stat switch
                {
                    ...
                    eCustomGraphStat.MaxEnd => "Max End",
                    eCustomGraphStat.SpeedRunning => "Run Speed",
                    eCustomGraphStat.SpeedJumping => "Jmp Speed",
                    eCustomGraphStat.JumpHeight => "Jmp Height",
