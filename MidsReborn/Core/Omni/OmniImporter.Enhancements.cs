...
{
    private void ApplyEnhancementImportStage(
        IDatabase database,
        string exportRoot,
        OmniExportManifest? manifest,
        OmniImportResult? analysisResult,
        OmniApplyResult applyResult)
    {
        ...
        var normalizedData = analysisResult?.CachedNormalizedEnhancementData ??
                             LoadNormalizedEnhancementImportData(exportRoot, manifest);
    ...
    public OmniApplyResult RefreshEnhancementImport(IDatabase database, string exportRoot)
    {
        ...
        ApplyEnhancementImportStage(database, normalizedRoot, null, null, applyResult);
        return applyResult;
    }
    ...
    {
        return effect == null ? Enums.eEnhance.None : EnhancementEffectMapper.MapEnhanceFromEffect(effect);
    }
