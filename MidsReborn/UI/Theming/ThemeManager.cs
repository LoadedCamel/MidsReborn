    ...
    private static Dictionary<string, ApplicationTheme> CreateBuiltInThemes()
    {
        ...
        var rogue = new ApplicationTheme
        {
            ...
            DataView = new DataViewTheme
            {
                ...
                Card = Color.FromArgb(23, 15, 15),
                Border = Color.FromArgb(54, 54, 54),
                Accent = Color.FromArgb(240, 240, 240),

                // Header tabs
                HeaderTop = Color.FromArgb(64, 30, 30),
                HeaderBottom = Color.FromArgb(97, 50, 50),
                TabActiveTop = Color.FromArgb(130, 46, 46),
                TabActiveBottom = Color.FromArgb(94, 24, 24),
                TabInactiveTop = Color.FromArgb(28, 24, 24),
                TabInactiveBottom = Color.FromArgb(20, 18, 18),
                TabBorder = Color.FromArgb(13, 11, 11),
                Text = Color.FromArgb(235, 235, 240),
                ValueText = Color.FromArgb(235, 235, 240),
                Muted = Color.FromArgb(185, 190, 200),

                // Controls
                Chip = Color.FromArgb(41, 29, 29),
                ChipActive = Color.FromArgb(99, 52, 52),
                Rail = Color.FromArgb(33, 25, 25),
                RailFill = Color.FromArgb(140, 60, 60),
                Thumb = Color.FromArgb(220, 236, 224),
                ThumbBorder = Color.FromArgb(31, 24, 24),

                // Grid
                GridHeaderTop = Color.FromArgb(36, 28, 28),
                GridHeaderBottom = Color.FromArgb(28, 20, 20),
                GridHeaderBorder = Color.FromArgb(18, 14, 14),
                GridRowEven = Color.FromArgb(23, 17, 17),
                GridRowOdd = Color.FromArgb(20, 14, 14),
                GridRowLine = Color.FromArgb(28, 22, 22),
                GridBandLow = Color.FromArgb(212, 95, 95),
                GridBandHigh = Color.FromArgb(230, 86, 86),
                GridNeutral = Color.FromArgb(185, 190, 200)
            },
            DropDownList = new DropDownListTheme
