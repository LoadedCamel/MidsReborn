...
namespace Mids_Reborn.UI.Controls
{
    public static class clsCustomBorderHandlers
    {
        ...
        [DllImport("user32.dll")]
        private static extern bool RedrawWindow(nint hWnd, nint lprcUpdate, nint hrgnUpdate, RedrawWindowFlags flags);
        ...
        public static void OnResizeRedrawWindow(nint ctlHandle)
        {
            RedrawWindow(ctlHandle, nint.Zero, nint.Zero, RedrawWindowFlags.Frame | RedrawWindowFlags.UpdateNow | RedrawWindowFlags.Invalidate);
        }
