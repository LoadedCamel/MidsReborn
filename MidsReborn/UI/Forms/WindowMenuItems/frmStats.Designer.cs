...
namespace Mids_Reborn.UI.Forms.WindowMenuItems
{
    public partial class frmStats
    {
        ...
        private void InitializeComponent()
        {
            ...
            Graph = new Mids_Reborn.UI.Controls.CtlMultiGraph();
            chkOnTop = new ImageButtonEx();
            btnClose = new ImageButtonEx();
            CompareGraph = new Mids_Reborn.UI.Controls.CtlMultiGraph();
            ...
            Graph.BarsAlignment = CtlMultiGraph.BarAlignment.Left;
            ...
            Graph.ScaleIndex = 7;
            Graph.SecondaryLabelPosition = CtlMultiGraph.Alignment.Right;
            ...
            chkOnTop.ButtonType = ImageButtonEx.ButtonTypes.Toggle;
            ...
            chkOnTop.ToggleState = ImageButtonEx.States.ToggledOff;
            ...
            CompareGraph.BarsAlignment = CtlMultiGraph.BarAlignment.Left;
            ...
            CompareGraph.RulerPos = CtlMultiGraph.RulerPosition.Top;
            CompareGraph.ScaleHeight = 16;
            CompareGraph.ScaleIndex = 7;
            CompareGraph.SecondaryLabelPosition = CtlMultiGraph.Alignment.Right;
            ...
            ibExport.ToggleState = ImageButtonEx.States.ToggledOff;
        ...
        private CtlMultiGraph CompareGraph;
