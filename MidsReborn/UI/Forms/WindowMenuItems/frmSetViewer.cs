...
namespace Mids_Reborn.UI.Forms.WindowMenuItems
{
    public partial class frmSetViewer : Form
    {
        ...
        public frmSetViewer(MainWindow iParent)
        {
        ...
        private Bitmap DrawEnhancementSetBitmap(int w, int h, int imgIndex)
        {
            ...
            var destRect = new Rectangle(0, 0, xb.Size.Width, xb.Size.Height);

            AssetManager.DrawEnhancementSet(graphics, destRect, imgIndex);
