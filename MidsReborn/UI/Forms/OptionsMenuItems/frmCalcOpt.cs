...
namespace Mids_Reborn.UI.Forms.OptionsMenuItems
{
    public partial class frmCalcOpt : Form
    {
        ...
        public frmCalcOpt(ref MainWindow iParent)
        {
...
Please move these items manually.", @"Move Completed With Exceptions", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
        ...
        private void SetControls()
        {
            ...
            rbGraphTwoLine.Checked = config.DataGraphType == Enums.MDmgGraphType.Stacked;
            rbGraphStacked.Checked = config.DataGraphType == Enums.MDmgGraphType.Layered;
            rbGraphSimple.Checked = config.DataGraphType == Enums.MDmgGraphType.BaseOnly;
        ...
        private void StoreControls()
        {
            ...
            {
                config.DataGraphType = Enums.MDmgGraphType.Stacked;
            }
            else if (rbGraphStacked.Checked)
            {
                config.DataGraphType = Enums.MDmgGraphType.Layered;
            }
            else if (rbGraphSimple.Checked)
            {
                config.DataGraphType = Enums.MDmgGraphType.BaseOnly;
            }
