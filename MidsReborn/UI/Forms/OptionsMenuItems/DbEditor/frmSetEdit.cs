...
namespace Mids_Reborn.UI.Forms.OptionsMenuItems.DbEditor
{
    public partial class FrmSetEdit : Form
    {
        ...
        private void btnImage_Click(object sender, EventArgs e)
        {
            ...
            if (!File.Exists(Path.Combine(AssetManager.GetDbEnhancementsPath(), imageFile)))
            {
                MessageBox.Show($@"You must select an image from the {AssetManager.GetDbEnhancementsPath()} folder!\r\n\r\nIf you are adding a new image, you should copy it to the folder and then select it.", @"Select Image", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
            else
            {
