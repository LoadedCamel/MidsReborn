...
namespace Mids_Reborn.UI.Forms.OptionsMenuItems.DbEditor
{
    public partial class frmDBEdit : Form
    {
        ...
        {
            MessageBox.Show(AppDataPaths.FileData, "File Loading Report", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
        ...
        private readonly MainWindow2 _frmMain;
        ...
        private async void btnDbCreate_Click(object sender, EventArgs e)
        {
            ...
            var path = Path.Combine(AppContext.BaseDirectory, AppDataPaths.RoamingFolder, dbName);
            ...
            var files = Directory.GetFiles(Path.Combine(AppContext.BaseDirectory, AppDataPaths.RoamingFolder, "Generic"));
