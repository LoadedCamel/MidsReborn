    ...
    public partial class frmRecipeViewer : Form
    {
        ...
        private void AddToImageList(int eIDX)
        {
            ...
            if (enhancement.ImageIdx > -1)
            {
                ...
                AssetManager.DrawEnhancementAt(graphics, destRect, enhancement.ImageIdx, Origin.Grade.IO);
        ...
        private void DrawIcon(int index)
        {
            ...
            extendedBitmap.Graphics.DrawImageUnscaled(index > -1 ? AssetManager.Enhancements[index].Bitmap : Resources.Icon_AncientMemories, 0, 0);
            extendedBitmap.Graphics.DrawImageUnscaled(index > -1 ? AssetManager.Enhancements[index].Bitmap : Resources.Icon_DisorientingField, 0, 0);
            ...
            PopUp.StringValue[] inStrs)
        {
            ...
            for (var index1 = 0; index1 <= num2; ++index1)
            {
                ...
                for (var index2 = 0; index2 <= num3; ++index2)
                {
                    ...
                    {
                        1 => colorRarityCompare(inStrs[numArray[index2]].Color, inStrs[index1].Color),
                        2 => colorRarityCompareB(inStrs[numArray[index2]].Color, inStrs[index1].Color),
                        _ => num1
                    };
